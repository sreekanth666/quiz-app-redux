...
function Quiz() {
    ...
    const handleNextQuestion = () => {
        ...
        if (controlScore) {
            ...
            // console.log("Dispatching Score Action");
        }
    }
    useEffect(() => {
    ...
    const [controlScore, setControlScore] = useState(false)
    const handleAnswer = (option, correct) => {
            setSelectedAnswer(option)
            if (correct[option] === "true") {
                setControlScore(true)
                // console.log("Correct");
            }
            else {
                // console.log("Incorrect");
                setControlScore(false)
            }
    }
        ...
        <>
            {
                ...
                <div>
                    ...
                    <div className='container mt-4'>
                        ...
                        <button className={selectedAnswer === "" ? `btn btn-success rounded-pill m-5 mx-auto d-block fw-semibold disabled` : `btn btn-success rounded-pill m-5 mx-auto d-block fw-semibold`} onClick={handleNextQuestion}>Next question <i class="fa-solid fa-circle-arrow-right"></i></button>
                    </div>
                </div>
            }
        </>
